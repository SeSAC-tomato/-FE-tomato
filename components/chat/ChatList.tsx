...
import {getChatLastReadUrl, getChatListFromRoomUrl} from "@/utils/chatUtils/constants";
...
const ChatList = ({newChats, roomId, reset}: Props) => {
    ...
    const fetchData = async (page: number) => {
        ...
        const data = await axiosGet<
            ...
            ChatDefaultPageRequest
        >((getChatListFromRoomUrl(roomId)), {page, size: 100});
    ...
    useEffect(() => {
        if (highestChatIdRef.current) {
            ...
            axiosGet(getChatLastReadUrl(roomId, highestChatIdRef.current));
        }
